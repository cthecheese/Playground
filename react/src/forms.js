...
var ControlledInput = React.createClass({
  ...
  render: function(){
    ...
    return (
      <input className="controlledTarget" type="text" value={value} onChange={this.changeName} />
    );
  }
});
...
var UncontrolledInput = React.createClass({
  render: function(){
    return (
      <input className="uncontrolledTarget" type="text" />
    );
  }
});
...
*/
var ControlledButNotMaintained = React.createClass({
  getInitialState: function(){
    return {
      name: "John Doe"
    }
  ...
  render: function(){
    var value = this.state.name;
    return (
      <input className="controlledButNotMaintainedTarget" value={value} type="text" />
    );
  }
});
...
/*
  ...
  So what if you want to give a default value but don't want to have component
    be controlled?

  Simple enough.. Just use defaultValue and it will output a default value and
    then you can just edit the input as normal.. The changes will be seen
    immediately.
*/
var UncontrolledDefaultValue = React.createClass({
  render: function(){
    var value = this.props.name;
    return (
      <input className="UncontrolledDefaultValueTarget" defaultValue={value} type="text" />
    );
  }
});

var UnControlledSelect = React.createClass({
  getInitialState: function(){
    return {
      value: "A"
    }
  ...
  render: function(){
    ...
    return(
      <select className="uncontrolledSelectTarget" value={value} onChange={this.handleChange}>
...
React.render(<ControlledInput />, document.getElementById('ControlledInput'));
React.render(<UncontrolledInput />, document.getElementById('UncontrolledInput'));
React.render(<ControlledButNotMaintained />, document.getElementById('ControlledButNotMaintained'));
React.render(<UncontrolledDefaultValue name="Jane Doe" />, document.getElementById('DefaultAndUncontrolled'));
React.render(<UnControlledSelect />, document.getElementById('UnControlledSelect'));

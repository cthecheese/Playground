...
var Title = React.createClass({
  ...
  render: function(){
    return(
      <div>
        <h1>{this.props.title + " " + this.props.number}</h1>
...
*/
React.render(<Title title="The Universe:" number={40} firstName="Colby"/>, document.getElementById('propValidationWrongNumber'));
React.render(<Title number={42} />, document.getElementById('propValidationNoTitle'));
React.render(<Title title="The Universe:" number={42} />, document.getElementById('propValidationNoFirstName'));
React.render(<Title title="The Universe:" number={42} firstName="Sam" />, document.getElementById('propValidationWrongFirstName'));

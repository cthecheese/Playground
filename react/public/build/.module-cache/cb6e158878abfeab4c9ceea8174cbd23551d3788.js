...
var UnControlledSelect = React.createClass({displayName: "UnControlledSelect",
  getInitialState: function(){
    return {
      value: "A"
    }
  ...
  render: function(){
    ...
    return(
      React.createElement("select", {className: "uncontrolledSelectTarget", value: value, onChange: this.handleChange}, 
...
React.render(React.createElement(UnControlledSelect, null), document.getElementById('UnControlledSelect'));

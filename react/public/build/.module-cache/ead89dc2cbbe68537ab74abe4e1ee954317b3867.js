...
React.render(React.createElement(AccountForm, {title: "Register", register: "true"}), document.body);

React.render(React.createElement(AccountForm, {title: "Login", register: "false"}), document.body);
